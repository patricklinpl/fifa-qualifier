...
const run = async () => {
  ...
  if (['afc', 'caf', 'concacaf', 'conmebol', 'inter', 'ofc', 'uefa'].indexOf(actions['confederationId']) > -1) await saveConfGameIds(actions['confederationId'].toUpperCase())

  if (['afc', 'caf', 'concacaf', 'conmebol', 'inter', 'ofc', 'uefa'].indexOf(actions['confederationStats']) > -1) await saveConfGameStats(actions['confederationStats'].toUpperCase())
